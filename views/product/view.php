...
<div class="recommended_items"><!--recommended_items-->
    ...
    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <?php $i=0; foreach ($hits as $hKey=>$hit) : ?>
                <?php if ($i%3==0): ?><div class="item <?php if ($i==0) echo "active"; ?>"><?php endif; ?>
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    ...
                                    <h2>$<?=$hit->price;?></h2>
                                    <p><?=Html::a($hit->name, ['product/view', 'cat'=>$hit->category->name, 'id'=>$hit->id], ['title' => $hit->name]);?></p>
                                    <p><?=$hit->name;?></p>
                                    <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                </div>
                            </div>
                ...
                <?php $i++; if ($i%3==0 or $i==count($hits)): ?></div><?php endif; ?>
            <?php endforeach; ?>
        </div>
